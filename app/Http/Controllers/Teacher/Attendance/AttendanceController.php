...
class AttendanceController extends Controller
{
    ...
    public function index($teacherId)
    {
        ...
        return view('teacher.attendance.index', compact('teacher', 'attendances'));
    }
    ...
    // 5. عرض تقرير الحضور لمحاضرة معينة
        ...
        
        {
            ...
            return view('teacher.attendance.report', compact('lecture', 'attendances'));
        }
    ...
    public function groupAttendance($teacherId, $groupId)
    {
        ...
        return view('teacher.attendance.index', compact('teacher', 'group', 'lectures', 'attendances'));
    }
}
