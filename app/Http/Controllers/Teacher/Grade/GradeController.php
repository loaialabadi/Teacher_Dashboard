...
class GradeController extends Controller
{
    ...
    public function index(Teacher $teacher)
    {
        ...
        return view('teacher.grades.index', compact('teacher', 'grades'));
    }
    ...
    public function create(Teacher $teacher)
    {
        ...
        return view('teacher.grades.create', compact('teacher', 'grades'));
    }
...
public function show(Teacher $teacher, Grade $grade)
{
    ...
    return view('teacher.grades.teacher_students', compact('students', 'teacher', 'grade'));
}
